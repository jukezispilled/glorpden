      ...
      <div className="relative h-full w-full flex justify-center items-center">
          <div className='flex justify-center mt-[42.5%] translate-x-3 md:mt-[30%] md:translate-x-10'>
            <div className='grid content-center z-40'>
              <a
                href="https://pump.fun/99etatrYfgEmbXfLqWTFbMfBZGsWseMNx97Dwhanpump"
              ...
              <div className='pt-8 text-center font-custom text-2xl flex justify-center -mt-3'>
                <a href="https://x.com/joeglorpden" className='p-2 md:hover:scale-110 transition ease-in-out duration-200'><img src={Xlogo} alt='Xlogo' className='w-12 h-12 rounded-md'></img></a>
                <a href="https://t.me/JoeGlorpden" className='p-2 md:hover:scale-110 transition ease-in-out duration-200'><img src={TG} alt='Tg logo' className='w-12 h-12'></img></a>
              </div>
            </div>
          </div>
      </div>
